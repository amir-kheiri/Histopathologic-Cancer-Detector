# -*- coding: utf-8 -*-
"""
Created on Sat Feb 13 18:39:13 2021
...
dataset_df = pd.read_csv("train_labels/train_labels.csv")
...
input_shape = (96, 96, 3)
pretrained_layers = VGG16(weights=None, include_top= False, input_shape=input_shape)  #'imagenet'
...
train_step_size = (train_generator.n // train_generator.batch_size)//100.0
validation_step_size =( validation_generator.n // validation_generator.batch_size)//100
...
src="HistoPictures\testFolder\test"
...
test_generator = test_datagen.flow_from_directory(
    directory="HistoPictures/testFolder",#test_folder,
    target_size=target_size,
    batch_size=1,
    shuffle=False,
    class_mode='binary')
